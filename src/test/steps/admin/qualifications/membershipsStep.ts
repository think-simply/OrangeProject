...
Then(
  "All elements are displayed as expected in Memberships",
  async function () {
...
When(
  "User inputs valid data for Membership contains name {string}",
  async function (name) {
...
When(
  "User clicks Update icon for Membership has name {string}",
  async function (nameToUpdate) {
...
When(
  "User clicks Delete icon for Membership has name {string}",
...
When(
  "User selects multiple memberships contain name {string} and {string}",
  async function (name1, name2) {
