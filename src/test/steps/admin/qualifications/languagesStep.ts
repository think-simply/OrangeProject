...
When(
  "Input valid data for Language contains name {string}",
  async function (name) {
...
When(
  "User clicks Update icon for Language has name {string}",
...
When(
  "User clicks Delete icon for Language has name {string}",
...
When(
  "User selects multiple languages contain name {string} and {string}",
