...
When("User clicks Cancel button after data input for Licenses", async function () {
...
When("User clicks Save button after data input for Licenses", async function () {
    await licensesPage.clickSaveBtn()
})
Then("Error message appears for required field for Licenses", async function () {
...
Then("Delete confirmation dialog appears as expected for Licenses", async function () {
...
Then("Delete confirmation dialog disappears & record is deleted for Licenses", async function () {
    await licensesPage.verifyDialogDismissed()
    await licensesPage.waitForRecordItem()
