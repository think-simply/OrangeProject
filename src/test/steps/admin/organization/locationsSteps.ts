...
//LO_06: Update an existing location
...
When(  "User clicks the Delete icon for a location",
  ...
  async () => {
    const adminMenuPage = new LocationsAdminPage(pageFixture.adminPage);
    // Add specific logic for clicking the Delete icon
  }
);
...
When(  "User confirms the deletion",
  ...
  async () => {
    const adminMenuPage = new LocationsAdminPage(pageFixture.adminPage);
    // Add specific logic for confirming the deletion
  }
);
...
Then(  "The location should be deleted",
  ...
  async () => {
    const adminMenuPage = new LocationsAdminPage(pageFixture.adminPage);
    // Add specific validation to check the location is deleted
  }
);
...
When(  "User clicks the Delete button",
  ...
  async () => {
    const adminMenuPage = new LocationsAdminPage(pageFixture.adminPage);
    // Add specific logic for clicking the Delete button
  }
);
...
Then(  "all selected locations should be deleted",
  ...
  async () => {
    const adminMenuPage = new LocationsAdminPage(pageFixture.adminPage);
    // Add specific validation to check all selected locations are deleted
  }
);
