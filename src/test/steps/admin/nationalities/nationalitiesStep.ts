...
Then(
  "All elements are displayed as expected in Nationalities",
  async function () {
...
When(
  "User inputs valid data for Nationality contains name {string}",
  async function (name) {
...
When(
  "User clicks Update icon for Nationality with name {string}",
  async function (name) {
...
When(
  "User clicks Delete icon for Nationality name is {string}",
  async function (nameToDelete) {
...
When(
  "User selects multi nationality names are {string} and {string}",
  async function (nameToDelete1, nameToDelete2) {
    await nationalitiesPage.selectMultipleNationalities(
      nameToDelete1,
      nameToDelete2
    );
  }
