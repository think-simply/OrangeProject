...
Then("A new provider with name {string} has been created", async function (text) {
...
Then("All selected provider contain text {string} have been deleted", async function (text) {
